"""Business Model Agent — Wave 1, Flash. Returns BusinessModelResult."""
...
_PROMPT_PATH = Path(__file__).parent.parent / "prompts" / "business_model.txt"
...
class BusinessModelAgent(PrometheusAgent[BusinessModelResult]):
    name: ClassVar[AgentName] = AgentName.BUSINESS_MODEL
    wave: ClassVar[Wave] = Wave.WAVE_1
    model: ClassVar[str] = settings.model_flash
    output_schema: ClassVar[type] = BusinessModelResult
